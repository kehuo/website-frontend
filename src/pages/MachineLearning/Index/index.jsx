...
export const Index = (props) => {
  const {
    dispatch,
    loading,
    machineLearningAndIndex: { list },
  } = props;
  useEffect(() => {
    dispatch({
      type: 'machineLearningAndIndex/fetch',
      payload: {
        count: 8,
      },
    });
...
export default connect(({ machineLearningAndIndex, loading }) => ({
  machineLearningAndIndex,
  loading: loading.models.machineLearningAndIndex,
}))(Index);
